    ...
    return (
        <View className="m-3 p-3 bg-white rounded-2xl">
            <View className="flex-row justify-left space-x-4">
                ...
                <View>
                    <Text className="text-gray-700 font-bold text-lg">{MealConstants.BREAKFAST}</Text>
                    <Text className="text-gray-700 text-sm">732 calories logged</Text>
                </View>
            </View>
            <ItemAlignComponentForMeal items={categories} collapsed={collapsed} category={MealConstants.CATEGORY} time={MealConstants.BREAKFAST} />
        </View>
    )
}
