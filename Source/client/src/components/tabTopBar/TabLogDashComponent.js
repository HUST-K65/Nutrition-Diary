...
import { Text, TouchableOpacity, TouchableWithoutFeedback, View, Modal, StyleSheet, Pressable } from 'react-native'
import AntDesign from 'react-native-vector-icons/AntDesign'
import DatePicker from "react-native-modern-datepicker";
import { getFormatedDate } from "react-native-modern-datepicker";

export default function TabLogDashComponent({ indexComponentActive }) {

    if (indexComponentActive === 0 || indexComponentActive === 1) {
        ...
        return (
            <View className="flex-row flex-1 space-x-4 items-center justify-between pl-1 pr-1">
                ...
                <View className="flex-row items-center space-x-4">
                    ...
                    >
                        <Text className="text-xl text-white">{selectedStartDate}</Text>
                    </TouchableOpacity>
